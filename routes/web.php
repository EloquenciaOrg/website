...
Route::put('/member_update_password', [MemberController::class, 'updatePassword'])->middleware('throttle.custom:3,1');
...
Route::get('/', [ParametreController::class, 'index_welcome'])->name('index');
