  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="{{ asset('images/journee_asso.webp') }}" class="img-fluid rounded shadow" alt="Notre histoire" style="height: 300px;">
      </div>
      ...
      <div class="col-lg-6">
        ...
        <p class="text-muted">
          C’est ainsi que Marouan a proposé à son ami Gaëtan, ex-vice-président de l’association, de l’aider à mettre en place ce projet ambitieux.
        </p>
      </div>
  ...
  <div class="container">
    ...
    <div class="timeline">
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Septembre 2023</h5>
        <p>Premières réflexions sur l'association</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Février 2024</h5>
        <p>Déclaration en Préfecture</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Septembre 2024</h5>
        <p>Lancement officiel</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Novembre 2024</h5>
        <p>Signature du premier partenariat avec EVA</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Février 2025</h5>
        <p>Premier anniversaire de l'association</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Mars 2025</h5>
        <p>Première participation de Rhétoria en tant que présentatrice de concours d'éloquence</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Août 2025</h5>
        <p>Publication de la version 2 du site</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Avril 2026</h5>
        <p>Premier concours d'éloquence</p>
      </div>
      <div class="timeline-step">
        <h5 class="fw-bold text-main-color">Mars 2026</h5>
        <p>Eloquéncia devient Rhétoria</p>
      </div>
  </div>
  </section>
  ...
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6 col-xl-5">
        <img class="img-fluid rounded" loading="lazy" src="{{ asset('images/logo_rhetoria.png') }}" alt="logo" style="height:400px;">
      </div>
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="mb-5"> Le logo de Rhétoria a tout d’abord été « Eloquéncia, première Edition » car le but premier était seulement d’accompagner les élèves de collèges et lycées à un concours de fin d’année. Cependant, le président a par la suite préféré que l’association soit plus accessible et qu’elle puisse proposer des activités plus diverses et concerner un plus large public. </p>
            <div class="row gy-4 gy-md-0 gx-xxl-5X">
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#005dff" class="bi bi-gear-fill" viewBox="0 0 16 16">
              ...
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#005dff" class="bi bi-fire" viewBox="0 0 16 16">
      ...
      <div class="col-lg-8">
        <div class="p-4 rounded shadow-sm bg-warning bg-opacity-25 position-relative">
          ...
          <p class="fs-5 text-dark">
            Le nom <span class="fw-bold">Rhétoria</span> est inspiré du provençal dans le but de rendre hommage à notre culture locale, que nous avons à cœur de préserver.
          </p>
