...
@section('content')
  ...
  <div class="bg-white p-4 shadow rounded mb-4 border-start border-4 border-warning">
    ...
    <p class="mb-1">Numéro RNA : W134011269</p>
    <p class="mb-1">Code APE : 94.99Z</p>
    <p class="mb-1">N° de TVA intracommunautaire : FR38451225999</p>
    <p class="mb-1">Siège social : 34 allée des chemin</p>
    <p class="mb-1">Résidence le train bleu, Entrée A</p>
    </p>
  </div>
  ...
  <div class="bg-white p-4 shadow rounded mb-4 border-start border-4 border-warning">
    ...
    <p>Hébergeur : OVH SAS , 2 rue Kellermann - 59100 Roubaix - France. Site : <a href="https://ovhcloud.com" class="text-warning">ovhcloud.com</a>.</p>
  </div>
